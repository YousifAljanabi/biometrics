...
#         self.fc_loc = layers.Dense(1, activation='tanh')
#
...
#
#         # Get rotation angle
#         theta = self.fc_loc(x)  # [batch_size, 1]
#         angle = theta[:, 0] * np.pi  # Convert to radians
#
...
#
# def train_stn_model(model, train_data, val_data, epochs=50):
#     """
#     Train STN model
#
#     Args:
#         model: STN model to train
#         train_data: Training dataset (distorted_images, target_images)
...
#     distorted_dir = "/path/to/distorted/images"  # Replace with your distorted images directory
#
...
#     test_image_path = "/path/to/test/distorted/image.jpg"  # Replace with your test image path
#
